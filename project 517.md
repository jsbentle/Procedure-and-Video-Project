...
\[Identifying Phishing\](\#identifying-phishing)  
\[Common Phishing Scams\](\#common-phishing-scams)  
\[Compromised Account\](\#compromised-accounts)  
...
\-Fake job offers  
\-Tuition or scholarship money  
\-Spamming DUO notifications  
\-Sharing documents that require your log-in to view them
...
2\. Check DUO devices: Look at the trusted devices under \[DUO device management\](https://ncsu.service-now.com/kb\_view.do?sysparm\_article=KB0016403) list to ensure there are no unknown devices present.  
3\. Report the email: use Google’s built in phishing report options, or forward the email to \[[phishing@ncsu.edu](mailto:phishing@ncsu.edu).\](mailto:phishing@ncsu.edu)  
...
You can report suspected phishing through Google’s built-in reporting feature. Open the suspicious email on a computer, click the More option (three vertical dots) at the top-right corner and select Report phishing. 

You can also forward suspicious emails to \[phishing@ncsu.edu.\](mailto:phishing@ncsu.edu)

Need an immediate response? Contact the NC State Help Desk via the NC State IT Service Portal or call 919.515.4357.
